                    ...
                    <tr>
                        <td style="padding:30px;">
                            ...
                            <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse;">
                                <tr>
                                    <td
                                        style="width:150px; color:#24416B; font-weight:bold; font-size:14px; vertical-align:top;">
                                        Guest Name</td>
                                ...
                                <tr>
                                    <td style="color:#24416B; font-weight:bold; font-size:14px; vertical-align:top;">
                                        Guests</td>
                                    <td style="color:#333; font-size:14px;">{{ $booking->adults }} Adults,
                                        {{ $booking->children }} Children</td>
                                </tr>
                                <tr>
                                    <td style="color:#24416B; font-weight:bold; font-size:14px; vertical-align:top;">
                                        Total Amount</td>
                                    <td style="color:#333; font-size:14px; font-weight:bold;">
                                        ₹{{ number_format($booking->total_amount, 0) }}</td>
                                </tr>
                                @if ($booking->message)
                                    <tr>
                                        <td
                                            style="color:#24416B; font-weight:bold; font-size:14px; vertical-align:top;">
                                            Message</td>
