                    ...
                    <tr>
                        <td style="padding:30px;">
                            ...
                            <p style="color:#555; font-size:14px; margin-bottom:20px;">
                                A new user has just signed up on your website.
                            </p>

                            <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse;">
                                <tr>
                                    <td style="width:130px; color:#24416B; font-weight:bold; font-size:14px; vertical-align:top;">Name</td>
                                    <td style="color:#333; font-size:14px;">{{ $userData['name'] }}</td>
                                </tr>
                                <tr>
                                    <td style="color:#24416B; font-weight:bold; font-size:14px; vertical-align:top;">Email</td>
                                    <td style="color:#333; font-size:14px;">{{ $userData['email'] }}</td>
                                </tr>
                                <tr>
                                    <td style="color:#24416B; font-weight:bold; font-size:14px; vertical-align:top;">Phone</td>
                                    <td style="color:#333; font-size:14px;">{{ $userData['phone'] ?? 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <td style="color:#24416B; font-weight:bold; font-size:14px; vertical-align:top;">Registered On</td>
                                    <td style="color:#333; font-size:14px;">{{ now()->format('d M Y, h:i A') }}</td>
                                </tr>
                            </table>
