                    ...
                    <tr>
                        <td style="padding:35px 30px;">
                            ...
                            <p style="color:#555; font-size:15px; line-height:1.7;">
                                Thank you for reaching out to us. We've received your message and our team will get back
                                to you within 24 hours.
                            </p>

                            <div
                                style="background-color:#f9f9f9; border-left:4px solid #cc8c18; padding:15px 20px; margin:25px 0;">
                                <p style="margin:0; color:#555; font-size:14px;"><strong>Your message:</strong></p>
                                <p style="margin:8px 0 0; color:#777; font-size:14px; font-style:italic;">
                                    {{ $formData['message'] }}</p>
                            </div>
